...
/*all these are callback functions which use a combination of functions in player.c
* to perform functions and the configure function uses these to configure the buttons
* of GUI to the calculation and display functions*/
