...
/*the tutorial mode executes these callbacks one after the other and each callback changes the configuration of the Tutorial MOde Button
* all buttons represent one tutorial lesson each*/
